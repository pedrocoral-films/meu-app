      ...
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media(min-width:84rem){
          ...
          .side-banner-left{left:.75rem}
          .side-banner-right{right:.75rem}
          .side-banner img{width:100%;height:100%;object-fit:cover;border-radius:1.35rem;border:1px solid rgba(0,240,255,.18);box-shadow:0 1.25rem 3.75rem rgba(0,0,0,.42),0 0 1.5rem rgba(0,240,255,.08);filter:saturate(1.04) contrast(1.04)}
        }
